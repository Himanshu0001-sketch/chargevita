...
const points = [
  {
    icon: <GiPlantRoots className="text-5xl text-green-500" />,
    title: "Organic Ingredients",
    desc: "Sourced from nature, our formulas are rooted in purity, safety, and tradition.",
    number: "01",
  },
  {
    icon: <FaBan className="text-5xl text-red-500" />,
          ...
          {points.map((item, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              ...
              <div className="relative mb-6">
                <div className="w-28 h-28 border border-dashed border-orange-400 rounded-full flex items-center justify-center">
                  {item.icon}
                </div>
